...
import com.zwenex.ayoe.yangonshelf.databinding.ActivityBorrowedBooksBinding
import com.zwenex.ayoe.yangonshelf.databinding.ActivityYourBooksBinding

class BorrowedBooksActivity : AppCompatActivity(),MyRecyclerViewAdapter.OnClickListener {
    override fun onClick(position: Int, view: View) {
        val book : Book? = adapter.getItemAtPosition(position)
        val bookDialog : DialogFragment = BookDialogFragment(adapter.getAllItems()!!,position,false)
    ...
    lateinit var binding: ActivityBorrowedBooksBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_borrowed_books)
        ...
        val recyclerView = binding.borrowedRecycler
        recyclerView.layoutManager = mLayoutManager
        recyclerView.adapter = adapter

        swipeRefresh = binding.borrowedSwipe
